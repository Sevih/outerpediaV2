...
from config import (
    ...
    PUBLIC_BOSS_SKILL, PUBLIC_BOSS_PORTRAIT, PUBLIC_BOSS_MINI,
...
BOSS_SKILL_IMAGE_FOLDER = PUBLIC_BOSS_SKILL
BOSS_PORTRAIT_IMAGE_FOLDER = PUBLIC_BOSS_PORTRAIT
BOSS_MINI_IMAGE_FOLDER = PUBLIC_BOSS_MINI
