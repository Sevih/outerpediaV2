...
const zh: Record<TranslationKey, string> = {
  ...
  'tools.team-planner.chain_order': '连锁顺序',
  'tools.team-planner.chain_order.desc': '拖动以重新排列连锁攻击顺序。',
  'tools.team-planner.chain_valid': '有效连锁: 起始 → 加入 → 终结',
  'tools.team-planner.chain_invalid': '无效连锁 — 需要起始、加入和终结',
  'tools.team-planner.team_buffs': '队伍增益',
  'tools.team-planner.team_debuffs': '队伍减益',
  'tools.team-planner.no_effects': '添加角色以查看队伍效果。',
  'tools.team-planner.chain_effects': '连锁效果',
  'tools.team-planner.dual_attack_effects': '双重攻击效果',
