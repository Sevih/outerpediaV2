...
const zh: Record<TranslationKey, string> = {
  ...
  'tools.patch-notes': '更新公告 & 开发者笔记',
  'tools.patch-notes.desc': '浏览所有更新公告、开发者笔记、英雄大全等。',
  'tools.patch-notes.era.major9': 'Major9（2025年10月起）',
  'tools.patch-notes.era.smilegate': 'Smilegate（2023–2025）',
  'tools.patch-notes.type.update': '更新',
  'tools.patch-notes.type.notice': '公告',
  'tools.patch-notes.type.event': '活动',
  'tools.patch-notes.type.devnote': '开发者笔记',
  'tools.patch-notes.type.known-issue': '已知问题',
  'tools.patch-notes.type.patchnotes': '更新说明',
  'tools.patch-notes.type.compendium': '大全',
  'tools.patch-notes.type.media-archives': '媒体',
  'tools.patch-notes.type.official-4-cut-cartoon': '四格漫画',
  'tools.patch-notes.type.probabilities': '概率',
  'tools.patch-notes.type.world-introduction': '世界介绍',
  'tools.patch-notes.type.developer-notes': '开发者笔记',
  'tools.patch-notes.zh_fallback': '该内容暂无中文版本，以英文显示。',
  'tools.patch-notes.legacy_en_only': 'Stove时代的内容仅提供英文版。',
  ...
  'tools.event': '活动',
  'tools.event.desc': '查看正在进行和即将到来的游戏内活动。',
