...
const kr: Record<TranslationKey, string> = {
  ...
  'tools.patch-notes.era.major9': 'Major9 (2025년 10월~)',
  'tools.patch-notes.era.smilegate': 'Smilegate (2023–2025)',
  'tools.patch-notes.type.update': '업데이트',
  'tools.patch-notes.type.notice': '공지사항',
  'tools.patch-notes.type.event': '이벤트',
  'tools.patch-notes.type.devnote': '개발자 노트',
  'tools.patch-notes.type.known-issue': '알려진 이슈',
  'tools.patch-notes.type.patchnotes': '패치 노트',
  'tools.patch-notes.type.compendium': '대전',
  'tools.patch-notes.type.media-archives': '미디어',
  'tools.patch-notes.type.official-4-cut-cartoon': '4컷 만화',
  'tools.patch-notes.type.probabilities': '확률',
  'tools.patch-notes.type.world-introduction': '세계 소개',
  'tools.patch-notes.type.developer-notes': '개발자 노트',
  'tools.patch-notes.zh_fallback': '이 콘텐츠는 중국어로 제공되지 않아 영어로 표시됩니다.',
  'tools.patch-notes.legacy_en_only': 'Stove 시대의 콘텐츠는 영어로만 제공됩니다.',
