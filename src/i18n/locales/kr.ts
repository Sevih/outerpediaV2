...
const kr: Record<TranslationKey, string> = {
  ...
  'tools.tierlistpve.desc': '아우터플레인 PvE 티어 리스트 — 모험, 보스, 레이드, 엔드게임 콘텐츠 최적 캐릭터.',
  ...
  'tools.gear-usage-statistics.tab.sets': '세트',
  'tools.gear-usage-statistics.tab.talismans': '탈리스만',
  ...
  'tools.gear-usage-finder.step_substats': '서브 스탯 (선택)',
  'tools.gear-usage-finder.step_set': '세트 선택',
  'tools.gear-usage-finder.mode_reco': '추천',
  'tools.gear-usage-finder.mode_reco.desc': '빌드 추천에 있는 스탯과 장비만 표시합니다. 메인 스탯으로 엄격하게 필터링합니다.',
  'tools.gear-usage-finder.mode_free': '자유',
  ...
  'tools.patch-history.type.notice': '공지사항',
  'tools.patch-history.type.event': '이벤트',
  'tools.patch-history.type.devnote': '개발자 노트',
  'tools.patch-history.type.known-issue': '알려진 이슈',
  'tools.patch-history.type.patchnotes': '패치 노트',
  'tools.patch-history.type.compendium': '대전',
  'tools.patch-history.type.media-archives': '미디어',
  'tools.patch-history.type.official-4-cut-cartoon': '4컷 만화',
  'tools.patch-history.type.probabilities': '확률',
  'tools.patch-history.type.world-introduction': '세계 소개',
  'tools.patch-history.type.developer-notes': '개발자 노트',
  'tools.patch-history.zh_fallback': '이 콘텐츠는 중국어로 제공되지 않아 영어로 표시됩니다.',
  'tools.patch-history.legacy_en_only': 'Stove 시대의 콘텐츠는 영어로만 제공됩니다.',
  ...
  'tools.pull-simulator.banner.limited': '한정',
  'tools.pull-simulator.pull1': '1연',
  'tools.pull-simulator.pull10': '10연',
  'tools.pull-simulator.mileage': '마일리지',
  'tools.pull-simulator.use_mileage': '마일리지 사용',
  'tools.pull-simulator.reset': '리셋',
  'tools.pull-simulator.stats': '통계',
  'tools.pull-simulator.total_pulls': '총 뽑기 수',
  'tools.pull-simulator.total_ether': '총 에테르',
  'tools.pull-simulator.first_3star': '첫 3★',
  'tools.pull-simulator.first_focus': '첫 픽업',
  'tools.pull-simulator.history': '뽑기 기록',
  'tools.pull-simulator.results': '결과',
  'tools.pull-simulator.focus': '픽업',
  'tools.pull-simulator.no_pulls': '픽업 캐릭터를 선택하고 시작하세요!',
  'tools.pull-simulator.select_focus': '픽업 캐릭터',
  'tools.pull-simulator.search_placeholder': '검색…',
  'tools.pull-simulator.batch': '배치',
  'tools.pull-simulator.ether_cost': '에테르 / 1회',
  ...
  'tools.event.type.contest': '콘테스트',
  'tools.event.type.community': '커뮤니티',
  'tools.event.status.ongoing': '진행 중',
  'tools.event.status.upcoming': '예정',
  'tools.event.status.ended': '종료',
  ...
  'tools.team-planner.chain_order': '체인 순서',
  'tools.team-planner.chain_order.desc': '드래그하여 체인 공격 순서를 변경하세요.',
  'tools.team-planner.chain_valid': '유효한 체인: 시작 → 참가 → 마무리',
  'tools.team-planner.chain_invalid': '잘못된 체인 — 시작, 참가, 마무리가 필요합니다',
  'tools.team-planner.team_buffs': '팀 버프',
  'tools.team-planner.team_debuffs': '팀 디버프',
  'tools.team-planner.no_effects': '캐릭터를 추가하여 팀 효과를 확인하세요.',
  'tools.team-planner.chain_effects': '체인 효과',
  'tools.team-planner.burst_effects': '버스트 효과',
  'tools.team-planner.dual_attack_effects': '듀얼 어택 효과',
  'tools.team-planner.team_name': '팀 이름',
  'tools.team-planner.team_name.placeholder': '예: 길드 레이드 화속 팀',
  'tools.team-planner.wip': '이 도구는 개발 중입니다. 일부 기능이 불완전하거나 변경될 수 있습니다.',
  'tools.team-planner.reset': '초기화',
  'tools.team-planner.share': '공유',
  'tools.tier-list-maker': '티어 리스트 메이커',
  'tools.tier-list-maker.desc': '나만의 아우터플레인 티어 리스트를 만들고 공유하세요. 캐릭터, 전용 장비, 보스를 평가하고 링크를 공유하거나 이미지로 내보낼 수 있습니다.',
  'tools.tier-list-maker.tab.characters': '캐릭터',
  'tools.tier-list-maker.tab.ee': '전용 장비',
  'tools.tier-list-maker.tab.bosses': '보스',
  'tools.tier-list-maker.search': '검색…',
  'tools.tier-list-maker.hint': '아이템을 티어로 드래그하거나, 아이템을 탭한 후 티어를 탭하세요.',
  'tools.tier-list-maker.title_placeholder': '나의 티어 리스트',
  'tools.tier-list-maker.add_row': '행 추가',
  'tools.tier-list-maker.clear_row': '이 행 비우기',
  'tools.tier-list-maker.delete_row': '이 행 삭제',
  ...
  'tools.tier-list-maker.copied': '링크가 복사되었습니다!',
  'tools.tier-list-maker.export': 'PNG로 내보내기',
  'tools.tier-list-maker.no_results': '아이템을 찾을 수 없습니다.',
  'tools.tier-list-maker.empty_pool': '모든 항목이 평가되었습니다!',
  'tools.tier-list-maker.confirm_reset': '전체 티어 리스트를 초기화할까요?',
  'tools.tier-list-maker.confirm_clear_row': '이 행을 비울까요?',
  'tools.tier-list-maker.confirm_delete_row': '이 행과 항목을 삭제할까요?',
  'tools.tier-list-maker.settings': '설정',
  'tools.tier-list-maker.icon_size': '아이콘 크기',
  'tools.tier-list-maker.size_s': 'S',
  'tools.tier-list-maker.size_m': 'M',
  'tools.tier-list-maker.size_l': 'L',
  'tools.tier-list-maker.show_names': '이름 표시',
  'tools.tier-list-maker.show_element': '속성 표시',
  'tools.tier-list-maker.show_class': '클래스 표시',
  'tools.tier-list-maker.show_rarity': '희귀도 표시',
  'tools.tier-list-maker.show_cards': '카드 표시(랭크 그리드)',
  'tools.tier-list-maker.card_size': '카드 크기',
  'tools.tier-list-maker.show_card_tags': '카드에 모집 태그 표시',
  ...
  'tools.tier-list-maker.sort_rarity': '희귀도',
  'tools.tier-list-maker.sort_element': '속성',
  'tools.tier-list-maker.tag.limited': '한정',
  'tools.tier-list-maker.tag.collab': '콜라보',
  'tools.tier-list-maker.tag.seasonal': '시즌',
  'tools.tier-list-maker.tag.free': '무료',
  'tools.tier-list-maker.tag.premium': '프리미엄',
  'tools.tier-list-maker.filter_skins_only': '스킨만',
  ...
  'tools.damage-calculator.panel.buffs': '버프 / 디버프',
  'tools.damage-calculator.panel.team': '팀',
  // Team panel — 3 ally slots
  'tools.damage-calculator.team.empty': '슬롯 {n} — 아군 선택',
  'tools.damage-calculator.team.exquisite_death': '절묘한 죽음',
  'tools.damage-calculator.team.absolute_music': '절대 음악',
  // Result panel — final damage + debug breakdown
  'tools.damage-calculator.result.empty': '딜러와 타겟을 선택하여 데미지 계산',
  'tools.damage-calculator.result.calculated': '계산 데미지',
  'tools.damage-calculator.result.no_crit': '일반',
  'tools.damage-calculator.result.debug': '디버그 상세',
  'tools.damage-calculator.result.pool': '풀 %',
  'tools.damage-calculator.result.rate': '레이트',
  'tools.damage-calculator.result.mitigation': '경감',
  'tools.damage-calculator.result.elem_mult': '속성 ×',
  'tools.damage-calculator.result.main_calc': '주공격',
  'tools.damage-calculator.result.add_calc': '추가공격',
  'tools.damage-calculator.result.steps': 'f32 추적',
  // Dev-only observation divergence table
  'tools.damage-calculator.obs.title': '관리자 관측 편차',
  'tools.damage-calculator.obs.divergent': '편차',
  'tools.damage-calculator.obs.matched': '일치',
  'tools.damage-calculator.obs.no_baseline': '기준 없음',
  'tools.damage-calculator.obs.no_baseline_hint': '`calculatedAtSave` 필드 추가 전에 저장됨 — 관리자에서 재저장하여 백필.',
  // Share panel — export / import calc state
  'tools.damage-calculator.share.title': '공유',
  'tools.damage-calculator.share.subtitle': '설정을 내보내 다른 사람이 재현할 수 있게 하거나, 공유를 붙여넣어 불러오기.',
  'tools.damage-calculator.share.export': '내보내기',
  'tools.damage-calculator.share.import': '가져오기',
  'tools.damage-calculator.share.copy': '복사',
  'tools.damage-calculator.share.apply': '적용',
  'tools.damage-calculator.share.copied': '클립보드에 복사됨.',
  'tools.damage-calculator.share.copy_fallback': '클립보드 차단됨 — 텍스트 선택됨, Ctrl+C로 복사.',
  'tools.damage-calculator.share.imported': '가져오기 성공.',
  'tools.damage-calculator.share.imported_with_warnings': '경고와 함께 가져옴: {warnings}',
  'tools.damage-calculator.share.paste_placeholder': '공유 JSON을 여기에 붙여넣기…',
  // Bug-report bundle inside the share envelope
  'tools.damage-calculator.share.report_section': '버그 리포트 (선택)',
  'tools.damage-calculator.share.report_calculated': '발신자 계산',
  'tools.damage-calculator.share.report_observed': '게임 내 관측',
  'tools.damage-calculator.share.report_delta': 'Δ 관측 vs 계산',
  'tools.damage-calculator.share.report_note': '노트',
  'tools.damage-calculator.share.report_note_placeholder': '컨텍스트, 재현 단계 등…',
  'tools.damage-calculator.obs.divergent_only': '편차만 표시',
  'tools.damage-calculator.obs.all_match': '모든 관측 일치 — 편차 없음.',
  'tools.damage-calculator.obs.col.char': '캐릭터',
  'tools.damage-calculator.obs.col.skill': '스킬',
  'tools.damage-calculator.obs.col.target': '타겟',
  'tools.damage-calculator.obs.col.observed': '관측값',
  'tools.damage-calculator.obs.col.admin_calc': '관리자 계산',
  'tools.damage-calculator.obs.col.our_calc': '당측 계산',
  'tools.damage-calculator.obs.col.delta_admin': 'Δ 관리자',
  'tools.damage-calculator.obs.col.delta_obs': 'Δ 관측',
  // Buffs panel — external % modifiers per stat (4-column layout)
  'tools.damage-calculator.buffs.col.attacker_buff': '시전자 버프',
  'tools.damage-calculator.buffs.col.attacker_debuff': '시전자 디버프',
  'tools.damage-calculator.buffs.col.target_buff': '타겟 버프',
  'tools.damage-calculator.buffs.col.target_debuff': '타겟 디버프',
  'tools.damage-calculator.buffs.marked': '표식',
  // Common UI strings
  'tools.damage-calculator.common.select': '— 선택 —',
  'tools.damage-calculator.common.no_matches': '결과 없음',
  'tools.damage-calculator.common.clear_slot': '슬롯 비우기',
  'tools.damage-calculator.common.clear_all': '모두 비우기',
  'tools.damage-calculator.common.reset': '초기화',
  ...
  'tools.damage-calculator.target.boss_badge': '보스',
  ...
  'tools.damage-calculator.target.manual.element': '속성',
  'tools.damage-calculator.target.manual.copy_from_selected': '선택에서 복사',
  ...
  'tools.damage-calculator.stat.label': '스탯',
  // Mode tabs (top-of-page toggle)
  'tools.damage-calculator.tab.single': '단일',
  ...
  'tools.damage-calculator.attacker.df': '스킬 DMG',
  'tools.damage-calculator.attacker.additional_attack': '추가 공격',
  'tools.damage-calculator.attacker.scaling_main': '메인 스케일링 스탯',
  'tools.damage-calculator.attacker.scaling_secondary': '서브 스케일링 스탯',
  // Attacker panel — conditional damage modifiers (drives pool_cond buffs)
  'tools.damage-calculator.attacker.cond.label': '조건부 보정',
  'tools.damage-calculator.attacker.cond.target_debuffs': '대상 디버프 수',
  'tools.damage-calculator.attacker.cond.enemy_team_deaths': '처치된 적 수',
  'tools.damage-calculator.attacker.cond.target_buffs': '대상 버프 수',
  'tools.damage-calculator.attacker.cond.team_buffs': '아군 버프 수',
  'tools.damage-calculator.attacker.cond.caster_lost_hp': '시전자 잃은 체력',
  'tools.damage-calculator.attacker.cond.target_lost_hp': '대상 잃은 체력',
  'tools.damage-calculator.attacker.cond.kill_stacks': '처치 스택',
  // Equipment panel labels
  'tools.damage-calculator.equipment.title': '장비 패시브',
  'tools.damage-calculator.equipment.empty': '비어있음 — 클릭하여 선택',
  'tools.damage-calculator.equipment.accessory': '액세서리',
  'tools.damage-calculator.equipment.ee': 'EE',
  'tools.damage-calculator.equipment.ee_active': '활성',
  'tools.damage-calculator.equipment.ee_inactive': '비활성',
  'tools.damage-calculator.equipment.ee_conditional': '조건부',
  'tools.damage-calculator.equipment.ee_conditional_hint': '런타임 조건에서 발동 — 게임 내에서 확인',
  'tools.damage-calculator.equipment.ee_no_data': '이 캐릭터에 등록된 EE가 없습니다',
  'tools.damage-calculator.equipment.no_passive_data': '패시브 데이터 없음',
  'tools.damage-calculator.equipment.4pc_hint': '다른 슬롯에 이미 있습니다 — 다시 선택하여 4세트 해제',
  'tools.damage-calculator.equipment.cf': 'CF',
  'tools.damage-calculator.equipment.base': '베이스',
  'tools.damage-calculator.equipment.passive_main': '메인',
  'tools.damage-calculator.equipment.passive_lv0': 'Lv0',
  'tools.damage-calculator.equipment.passive_lv10': 'Lv10',
  'tools.damage-calculator.equipment.tier_2pc': '2세트',
  'tools.damage-calculator.equipment.tier_4pc': '4세트',
  // Equipment picker modal titles
  'tools.damage-calculator.equipment.pick_weapon': '무기 선택',
  'tools.damage-calculator.equipment.pick_accessory': '액세서리 선택',
  'tools.damage-calculator.equipment.pick_set': '세트 선택 ({slot})',
  'tools.damage-calculator.equipment.pick_talisman': '탤리스만 선택',
  // Target picker categories (reuse guides.category.* for shared modes)
  'tools.damage-calculator.cat.story': '스토리',
  'tools.damage-calculator.cat.skyward_towers': '비천의 탑',
  'tools.damage-calculator.cat.elemental_towers': '속성의 탑',
  'tools.damage-calculator.cat.temporary_modes': '한정 모드',
  // Target picker sub-modes
  'tools.damage-calculator.sub.ecology_study': '생태 연구 (방어구)',
  'tools.damage-calculator.sub.identification': '감정 (무기)',
  'tools.damage-calculator.sub.weekly_conquest': '주간 정복',
  'tools.damage-calculator.sub.promotion': '승급',
  'tools.damage-calculator.sub.normal': '노말',
  'tools.damage-calculator.sub.hard': '하드',
  'tools.damage-calculator.sub.very_hard': '베리 하드',
  'tools.damage-calculator.sub.pursuit': '추격',
  'tools.damage-calculator.sub.infiltration': '잠입',
  // Transcend slider
  'tools.damage-calculator.attacker.burst_unlocked': '버스트 Lv {n} 해방',
  'tools.damage-calculator.attacker.team_bonuses': '아군:',
  'tools.damage-calculator.attacker.team_contribution_hint': '팀 기여는 계산 시 적용',
  'tools.damage-calculator.attacker.tier_lower': '단계 낮추기',
  'tools.damage-calculator.attacker.tier_raise': '단계 올리기',
  'tools.damage-calculator.attacker.tier_label': '초월 단계',
  ...
  'page.coupons.title': '아우터플레인 유효한 프로모 코드',
  'page.coupons.description':
    '아우터플레인 유효한 프로모 코드 목록. 게임 내에서 교환하여 무료 보상 획득: 에테르, 모집 티켓 등.',
  'coupons.expired': '만료된 코드',
  'coupons.active': '유효',
  'coupons.upcoming': '예정',
  'coupons.validity': '{start} — {end}',
  'coupons.redeem_android': 'Android: 메뉴 → 설정 → 쿠폰',
  'coupons.redeem_ios': 'iOS: <a href="https://coupon.outerplane.vagames.co.kr:39009/coupon" target="_blank" rel="noopener noreferrer" class="underline text-cyan-400">공식 웹사이트에서 교환</a>',
  // Coupon one-click redeem
  'coupons.redeem.title': '원클릭 쿠폰 사용',
  'coupons.redeem.desc': 'UID를 한 번 저장하면 이 페이지에서 바로 쿠폰을 사용할 수 있어요.',
  'coupons.redeem.uid_label': '플레이어 UID',
  'coupons.redeem.uid_placeholder': '예: 123456789',
  'coupons.redeem.server_label': '서버',
  'coupons.redeem.server_global1': '글로벌 1',
  'coupons.redeem.server_global2': '글로벌 2',
  'coupons.redeem.server_jp': '일본',
  'coupons.redeem.hint': 'UID는 게임 내 [설정] → [계정]에서 확인할 수 있습니다.',
  'coupons.redeem.save': '저장',
  'coupons.redeem.saved': '저장됨',
  'coupons.redeem.button': '사용',
  'coupons.redeem.busy': '사용 중…',
  'coupons.redeem.redeemed': '사용함',
  'coupons.redeem.need_setup': 'UID를 먼저 입력하세요',
  'coupons.redeem.disclaimer': '쿠폰은 Outerplane 공식 쿠폰 서비스로 직접 전송됩니다. Outerpedia는 아무것도 저장하지 않습니다.',
  'coupons.redeem.result.success': '쿠폰을 정상적으로 적용했습니다! 게임 내 우편함에서 보상을 받으세요.',
  'coupons.redeem.result.user_not_found': '해당 유저를 찾을 수 없습니다. UID와 서버를 확인하세요.',
  'coupons.redeem.result.invalid': '유효하지 않은 쿠폰입니다.',
  'coupons.redeem.result.expired': '쿠폰 유효기간이 만료되었습니다.',
  'coupons.redeem.result.exhausted': '쿠폰이 소진되었습니다.',
  'coupons.redeem.result.already_used': '이미 사용한 쿠폰입니다.',
  'coupons.redeem.result.same_type': '동일한 유형의 쿠폰을 이미 사용했습니다.',
  'coupons.redeem.result.maintenance': '쿠폰 서비스가 점검 중입니다. 잠시 후 다시 시도해주세요.',
  'coupons.redeem.result.rate_limited': '시도 횟수가 너무 많습니다. 잠시 후 다시 시도해주세요.',
  'coupons.redeem.result.network': '쿠폰 서비스에 연결할 수 없습니다. 잠시 후 다시 시도해주세요.',
  'coupons.redeem.result.unknown': '알 수 없는 에러가 발생했습니다.',
  ...
  'buff.type.frog-gold': '골드 +100%',
  'buff.type.frog-food': '음식 +100%',
  'buff.type.ark-raid': '방주 습격 +100%',
  'buff.type.special-ecology': '생태조사 +30%',
  'buff.type.special-identification': '정체규명 +30%',
  'buff.type.doppelganger': '조각 +1',
  'buff.type.kate-workshop': '제작 골드 -30%',
  'buff.type.story-survey': '조사 포인트 2배',
  'buff.type.evolution-stone': '진화석 2배',
  'buff.type.bounty-hunter': '현상 수배 2배',
  'buff.type.bandit-chase': '도적단 2배',
  ...
  'page.character.toc.reviews': '커뮤니티 리뷰',
  'page.character.reviews.count': '리뷰 {count}개',
  ...
  'page.character.pros_cons.show_more': '{count}개 더 보기',
  'page.character.pros_cons.show_less': '접기',
  ...
  'page.character.gear.amulet': '악세서리',
  ...
  'progress.task.hypnotic-frog-hall': '최면 개구리의 전당',
  'progress.task.ark-raid': '방주 습격',
