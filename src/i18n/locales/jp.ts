...
const jp: Record<TranslationKey, string> = {
  ...
  'tools.patch-notes': 'パッチノート & 開発者ノート',
  'tools.patch-notes.desc': 'パッチノート、開発者ノート、ヒーロー大全などを閲覧。',
  'tools.patch-notes.era.major9': 'Major9（2025年10月〜）',
  'tools.patch-notes.era.smilegate': 'Smilegate（2023〜2025）',
  'tools.patch-notes.type.update': 'アップデート',
  'tools.patch-notes.type.notice': 'お知らせ',
  'tools.patch-notes.type.event': 'イベント',
  'tools.patch-notes.type.devnote': '開発者ノート',
  'tools.patch-notes.type.known-issue': '不具合',
  'tools.patch-notes.type.patchnotes': 'パッチノート',
  'tools.patch-notes.type.compendium': '大全',
  'tools.patch-notes.type.media-archives': 'メディア',
  'tools.patch-notes.type.official-4-cut-cartoon': '4コマ漫画',
  'tools.patch-notes.type.probabilities': '確率',
  'tools.patch-notes.type.world-introduction': 'ワールド紹介',
  'tools.patch-notes.type.developer-notes': '開発者ノート',
  'tools.patch-notes.zh_fallback': 'このコンテンツは中国語では提供されていないため、英語で表示されています。',
  'tools.patch-notes.legacy_en_only': 'Stove時代のコンテンツは英語のみです。',
  ...
  'tools.event': 'イベント',
  'tools.event.desc': '開催中・今後のゲーム内イベントを確認。',
