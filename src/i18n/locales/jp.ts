...
const jp: Record<TranslationKey, string> = {
  ...
  'tools.tier-list-maker.show_cards': 'カードを表示（ランクグリッド）',
  'tools.tier-list-maker.card_size': 'カードサイズ',
  'tools.tier-list-maker.show_card_tags': 'カードに募集タグを表示',
  ...
  'tools.tier-list-maker.filter_skins_only': 'スキンのみ',
