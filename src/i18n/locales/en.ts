...
const en = {
  ...
  'tools.patch-notes.era.major9': 'Major9 (Oct 2025+)',
  'tools.patch-notes.era.smilegate': 'Smilegate (2023–2025)',
  'tools.patch-notes.type.update': 'Update',
  'tools.patch-notes.type.notice': 'Notice',
  'tools.patch-notes.type.event': 'Event',
  'tools.patch-notes.type.devnote': 'Dev Note',
  'tools.patch-notes.type.known-issue': 'Known Issue',
  'tools.patch-notes.type.patchnotes': 'Patch Notes',
  'tools.patch-notes.type.compendium': 'Compendium',
  'tools.patch-notes.type.media-archives': 'Media',
  'tools.patch-notes.type.official-4-cut-cartoon': '4-Cut Cartoon',
  'tools.patch-notes.type.probabilities': 'Probabilities',
  'tools.patch-notes.type.world-introduction': 'World Intro',
  'tools.patch-notes.type.developer-notes': 'Dev Note',
  'tools.patch-notes.zh_fallback': 'This content is displayed in English as it is not available in Chinese.',
  'tools.patch-notes.legacy_en_only': 'Stove-era content is only available in English.',
