...
const en = {
  ...
  'tools.tier-list-maker.show_cards': 'Show cards (ranked grid)',
  'tools.tier-list-maker.card_size': 'Card size',
  'tools.tier-list-maker.show_card_tags': 'Show recruit tags on cards',
  ...
  'tools.tier-list-maker.filter_skins_only': 'Skins only',
  ...
  'page.character.pros_cons.show_more': 'Show {count} more',
  'page.character.pros_cons.show_less': 'Show less',
