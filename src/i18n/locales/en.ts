...
const en = {
  ...
  'progress.task.bounty-hunter': 'Bounty Hunter',
  'progress.task.bandit-chase': 'Bandit Chase',
  'progress.task.upgrade-stone-retrieval': 'Upgrade Stone Retrieval',
  ...
  'progress.veronicaPremiumPackDesc': 'Increases daily limits from 3 to 4 for Bounty Hunter, Bandit Chase, and Upgrade Stone Retrieval',
