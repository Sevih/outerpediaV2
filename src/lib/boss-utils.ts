...
// Tokens come from the game text bundles, so they only exist in game-official languages.

export const ELEMENT_TOKENS: Record<GameLang, Record<string, string>> = {
...
export const CLASS_TOKENS: Record<GameLang, Record<string, string>> = {
