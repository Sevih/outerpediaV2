    ...
    <HoverCard.Root openDelay={0} closeDelay={0}>
      ...
      <HoverCard.Portal>
        <HoverCard.Content
          ...
          align="center"
          sideOffset={6}
          className={`z-50 max-w-[280px] rounded px-3 py-2 shadow-lg border border-white/10 ${bg}`}
        >
          {content}
...
function arrowClass(bg: string): string {
  if (bg.includes('sky')) return 'fill-sky-900/80';
  if (bg.includes('red')) return 'fill-red-900/80';
