...
const HEADINGS = {
  intro: {
    ...
    fr: "Resume du Offline Meeting de janvier 2026 ou Major9 et VAGames ont presente la roadmap 2026 d\'Outerplane."
  },
  developmentDirection: { en: "Development Direction", jp: "開発方針", kr: "개발 방향", zh: "开发方向", fr: "Orientation du developpement" },
  roadmapOverview: { en: "2026 Roadmap Overview", jp: "2026年ロードマップ概要", kr: "2026 로드맵 개요", zh: "2026路线图概览", fr: "Vue d\'ensemble de la roadmap 2026" },
  monthlyUpdates: { en: "Monthly Update Plans (January - July 2026)", jp: "月間アップデート計画（2026年1月〜7月）", kr: "월간 업데이트 계획 (2026년 1월 - 7월)", zh: "月度更新计划（2026年1月-7月）", fr: "Plans de mises a jour mensuelles (janvier - juillet 2026)" },
  newCharacters: { en: "New Characters Revealed", jp: "新キャラクター公開", kr: "신규 캐릭터 공개", zh: "新角色公开", fr: "Nouveaux personnages reveles" },
  coreFusion: { en: "Core Fusion Plans", jp: "コア融合計画", kr: "코어 융합 계획", zh: "核心融合计划", fr: "Plans Core Fusion" },
  dimensionSingularity: { en: "New PVE Content: Dimension Singularity", jp: "新PVEコンテンツ: 次元特異点", kr: "신규 PVE 콘텐츠: 차원 특이점", zh: "新PVE内容：次元奇点", fr: "Nouveau contenu PVE : Dimensional Singularity" },
  rta: { en: "RTA (Real-Time Arena)", jp: "RTA（リアルタイムアリーナ）", kr: "RTA (실시간 아레나)", zh: "RTA（实时竞技场）", fr: "RTA (Real-Time Arena)" },
  demiurgePlans: { en: "Demiurge/Limited/Rerun Plans", jp: "デミウルゴス/限定/復刻計画", kr: "데미우르고스/한정/복각 계획", zh: "神匠/限定/复刻计划", fr: "Plans Demiurge / limites / reruns" },
  coupon: { en: "Coupon Code", jp: "クーポンコード", kr: "쿠폰 코드", zh: "优惠码", fr: "Code coupon" },
};
