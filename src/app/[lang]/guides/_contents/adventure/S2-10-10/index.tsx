...
// Normal (4500154) → Vlada 4500275 , Hard (4500182) → Vlada 4500184
const VLADA_IDS = ["4500156", "4500184"];
...
export default function DrakhanGuide() {
  ...
  return (
    ...
    >
      ...
      <MinionDisplay
        entries={[
          { bossName: "Vlada", versionIndex: 0, defaultBossId: VLADA_IDS[minionIndex] },
        ]}
      />
