...
import boss51000006 from '@data/boss/51000006.json';
...
const preloadedBosses: Record<string, Boss> = {
  '51000006': boss51000006 as unknown as Boss,
};

/* ── Component ──────────────────────────────────────────── */

export default function ChimeraALGuide() {
  const { lang } = useI18n();
  ...
  return (
    ...
    >
      <BossDisplay
        bossName="Unidentified Chimera"
        modeKey="Adventure License"
        defaultBossId="51000006"
        ...
        videos={[
          {
            platform: 'youtube',
            id: 'lnu3aQP3bu0',
            title: 'Unidentified Chimera — Stage 10 — 1 run clear',
            author: 'ダイス',
          },
        ]}
      />
