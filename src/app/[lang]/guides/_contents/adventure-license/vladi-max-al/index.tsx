...
import boss51000030 from '@data/boss/51000030.json';
...
const preloadedBosses: Record<string, Boss> = {
  '51000030': boss51000030 as unknown as Boss,
};

/* ── Component ──────────────────────────────────────────── */

export default function VladiMaxALGuide() {
  const { lang } = useI18n();
  ...
  return (
    ...
    >
      ...
      <hr className="my-6 border-neutral-700" />
      <StageBasedTeamSelector teamData={teams} defaultStage="ETamamo Carry" />
      <hr className="my-6 border-neutral-700" />
      <MultiVideoEmbed
        videos={[
          {
            platform: 'youtube',
            id: 'MUtrB0Ix3sg',
            title: 'Vladi Max — Stage 10 — 1 run clear',
            author: 'ダイス',
          },
        ]}
      />
