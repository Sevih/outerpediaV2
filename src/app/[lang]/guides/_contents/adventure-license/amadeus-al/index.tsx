...
import boss51000026 from '@data/boss/51000026.json';
...
const preloadedBosses: Record<string, Boss> = {
  '51000026': boss51000026 as unknown as Boss,
};
        ...
        videos={[
          {
            platform: 'youtube',
            id: '_OcSxNxLzL8',
            title: 'Amadeus — Stage 10 — 1 run clear (no damage)',
            author: 'ダイス',
          },
        ]}
      />
