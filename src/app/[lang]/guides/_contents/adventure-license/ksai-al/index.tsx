...
import boss51000028 from '@data/boss/51000028.json';
...
const preloadedBosses: Record<string, Boss> = {
  '51000028': boss51000028 as unknown as Boss,
};

/* ── Component ──────────────────────────────────────────── */

export default function KsaiALGuide() {
  const { lang } = useI18n();
  ...
  return (
    ...
    >
      ...
      <hr className="my-6 border-neutral-700" />
      <StageBasedTeamSelector teamData={teams} defaultStage="Team 1 – Reliable Clear" />
      <hr className="my-6 border-neutral-700" />
      <MultiVideoEmbed
        videos={[
          {
            platform: 'youtube',
            id: 'ZR4yQJIq-oo',
            title: 'Ksai — Stage 10 — 1 run clear',
            author: 'ダイス',
          },
        ]}
      />
