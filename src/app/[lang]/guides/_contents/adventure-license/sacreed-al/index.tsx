...
export default function SacreedALGuide() {
  ...
  return (
    ...
    >
      ...
      />
      <MinionDisplay bossName="Deformed Inferior Core" modeKey="Adventure License" versionIndex={0} defaultBossId="51000022" />
      ...
      <hr className="my-6 border-neutral-700" />
      <MultiVideoEmbed
        hashPrefix="sacreed-al-video"
        videos={[
          {
            platform: 'youtube',
            id: 'oGtlmNdJ0xg',
            title: 'Sacred Guardian — Stage 10 — 1 run clear',
            author: 'ダイス',
            label: 'Stage 10',
          },
          {
            platform: 'youtube',
            id: 'smvurgplZkU',
            title: 'Sacred Guardian — 1 run clear',
            author: 'ダイス',
            label: 'Standard',
          },
        ]}
