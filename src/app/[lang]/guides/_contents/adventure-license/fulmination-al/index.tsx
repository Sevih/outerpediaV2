...
import boss51000029 from '@data/boss/51000029.json';
...
const preloadedBosses: Record<string, Boss> = {
  '51000029': boss51000029 as unknown as Boss,
};
...
export default function FulminationALGuide() {
  ...
  return (
    ...
    >
      <BossDisplay
        bossName="Vlada Assault Suit"
        modeKey="Adventure License"
        defaultBossId="51000029"
        ...
        videos={[
          {
            platform: 'youtube',
            id: 'zrRWzw4aJ-0',
            title: 'Vlada Assault Suit — Stage 10 — 1 run clear (no limited chars)',
            author: 'ダイス',
          },
        ]}
      />
