...
import boss51000012 from '@data/boss/51000012.json';
...
const preloadedBosses: Record<string, Boss> = {
  '51000012': boss51000012 as unknown as Boss,
};

/* ── Component ──────────────────────────────────────────── */

export default function MeteosALGuide() {
  const { lang } = useI18n();
        ...
        videos={[
          {
            platform: 'youtube',
            id: 'LWftUG0xfYQ',
            title: 'Blazing Knight Meteos — Stage 10 — 1 run clear',
            author: 'ダイス',
          },
        ]}
      />
