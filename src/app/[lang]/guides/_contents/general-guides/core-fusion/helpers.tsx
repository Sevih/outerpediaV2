...
export const LABELS = {
  intro: {
    ...
    fr: 'Les Héros Core Fusion sont des versions ameliorees de personnages existants, debloquees via le système Core Fusion. Ils nécessitent le personnage original à la transcendance 5★ et 300 {I-I/Fusion-Type Core} pour être debloques.\nUne fois debloques, tous les skills commencent au Lv1 et peuvent être level up ensemble pour 150 {I-I/Fusion-Type Core} par niveau, jusqu\'au Lv5 (900 au total). Ces unités ont aussi un Core Fusion Passive unique qui s\'amélioré en atteignant le Lv5.\nCe guide couvre les priorités de deblocage et les reviews pour chaque Héros Core Fusion.',
  },
  unlockPriority: {
    en: 'Unlock Priority',
    jp: '解放優先順位',
  ...
  noEntries: {
    ...
    zh: '暂无核心融合条目。',
    fr: 'Aucune entree Core Fusion pour le moment.',
  },
  skillChanges: {
    en: 'Skill Changes',
    jp: 'スキル変更',
