...
export const LABELS = {
    ...
    faqTitles: {
        ...
        dmgRedCap: { en: 'Is there a cap on Damage Reduction?', jp: 'ダメージ軽減に上限はありますか？', kr: '데미지 감소에 상한이 있나요?', zh: '伤害减免有上限吗？' } satisfies LangMap,
