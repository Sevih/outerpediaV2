                            ...
                            <div className="mt-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="ml-4 mt-2 space-y-3">
                                        ...
                                        <p>{lRec({ en: 'Enemy reactions such as', jp: '敵の反応（', kr: '적 반응(', zh: '敌方反应（' } satisfies LangMap, lang)} {parseText('{B/BT_STAT|ST_COUNTER_RATE}')}, {parseText('{B/BT_AGILE_RESPONSE}')}{lRec({ en: ' or', jp: '、', kr: ', ', zh: '、' } satisfies LangMap, lang)} {parseText('{B/BT_REVENGE}')}{lRec({ en: ' may occur, and also follow this positional order.', jp: 'など）も発生可能で、同じ位置順に従います。', kr: ' 등)도 발생 가능하며, 같은 위치 순서를 따릅니다.', zh: '等）也可能发生，遵循相同位置顺序。' } satisfies LangMap, lang)}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
