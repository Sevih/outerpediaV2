...
export const MODE_NAMES: Record<string, LangMap> = {
  'progress.task.joint-challenge': { en: 'Joint Challenge', jp: '共同作戦', kr: '합동 챌린지', zh: '联合挑战', fr: 'Joint Challenge' },
  'progress.shop.guild': { en: 'Guild', jp: '所属ギルド', kr: '소속 길드', zh: '所属公会', fr: 'Guilde' },
  'content.base': { en: 'Base', jp: 'アジト', kr: '아지트', zh: '基地', fr: 'Base' },
  'content.event-dungeon': { en: 'Event Dungeon', jp: 'イベントダンジョン', kr: '이벤트 던전', zh: '活动暗堡', fr: 'Event Dungeon' },
  'content.archdemon-deeps': { en: 'The Archdemon\'s Ruins: The Deeps', jp: '魔王の遺跡:深界', kr: '마왕의 유적: 심계', zh: '魔王遗迹:深界', fr: "The Archdemon's Ruins : The Deeps" },
  'talisman': { en: 'Talisman', jp: 'タリスマン', kr: '탈리스만', zh: '护身符', fr: 'Talisman' },
  'categories.skyward-tower': { en: 'Skyward Tower', jp: 'スカイワードタワー', kr: '스카이워드 타워', zh: '飞天之塔', fr: 'Skyward Tower' },
  'content.special-request-ecology': { en: 'Challenge! Special Request: Ecology Study', jp: '挑戦! 特別依頼:生態調査', kr: '도전! 특별의뢰 : 생태 조사', zh: '挑战!特别委托:生态调查', fr: 'Challenge! Special Request : Ecology Study' },
  'content.special-request-identification': { en: 'Challenge! Special Request: Identification', jp: '挑戦! 特別依頼:正体究明', kr: '도전! 특별의뢰 : 정체 규명', zh: '挑战!特别委托:查清身份', fr: 'Challenge! Special Request : Identification' },
  'content.arena': { en: 'Arena', jp: 'アリーナ', kr: '결투장', zh: '竞技场', fr: 'Arena' },
  'content.archdemon-corridor': { en: 'The Archdemon\'s Ruins: The Infinite Corridor', jp: '魔王の遺跡:無限の回廊', kr: '마왕의 유적: 무한의 회랑', zh: '魔王遗迹:无限回廊', fr: "The Archdemon's Ruins : The Infinite Corridor" },
  'progress.task.defeat-doppelganger': { en: 'Defeat the Doppelganger', jp: '自己像幻視退治', kr: '도플갱어 퇴치', zh: '击退二重身', fr: 'Battre le Doppelganger' },
  'categories.world-boss': { en: 'World Boss', jp: 'ワールドボス', kr: '월드 보스', zh: '世界首领', fr: 'World Boss' },
  'content.synchro-room': { en: 'Synchro Room', jp: 'シンクロルーム', kr: '싱크로 룸', zh: '同步空间', fr: 'Synchro Room' },
  'progress.task.elemental-tower': { en: 'Elemental Tower', jp: 'エレメンタルタワー', kr: '엘레멘탈 타워', zh: '元素之塔', fr: 'Elemental Tower' },
  'content.terminus-isle': { en: 'Terminus Isle', jp: 'テルミナス島', kr: '멸망의 섬', zh: '灭亡之岛', fr: 'Terminus Isle' },
  'progress.preciseCraft': { en: 'Precise Craft', jp: '精密作成', kr: '정밀 제작', zh: '精密制作', fr: 'Precise Craft' },
  'content.quirk': { en: 'Quirk', jp: 'ギフト', kr: '기프트', zh: '天赋', fr: 'Quirk' },
  'progress.task.adventure-license': { en: 'Adventure License', jp: '冒険者ライセンス', kr: '모험 라이선스', zh: '冒险许可证', fr: 'Adventure License' },
  'content.irregular-extermination': { en: 'Irregular Extermination Project', jp: 'イレギュラー殲滅戦', kr: '이레귤러 섬멸전', zh: '异型怪歼灭战', fr: 'Irregular Extermination Project' },
}

export const UNLOCK_NAMES: Record<string, LangMap> = {
  'dungeon.puppet': { en: 'Puppet', jp: '操り人形', kr: '꼭두각시', zh: '提线木偶', fr: 'Puppet' },
  'dungeon.prisoners': { en: 'Prisoners', jp: '受刑者', kr: '수감자', zh: '囚犯', fr: 'Prisoners' },
  'dungeon.gathering-supplies': { en: 'Gathering Supplies', jp: '物資補給', kr: '물자 보급', zh: '物资补给', fr: 'Gathering Supplies' },
  'dungeon.finding-blacksmith': { en: 'Finding Blacksmith', jp: '鍛冶屋の姉御', kr: '대장장이 확보', zh: '拉拢铁匠', fr: 'Finding Blacksmith' },
  'dungeon.onwards-to-magnolia': { en: 'Onwards to Magnolia', jp: 'マグノリアを目指して', kr: '매그놀리아를 향해', zh: '向着麦格诺里亚', fr: 'Onwards to Magnolia' },
  'dungeon.her-name-is-alpha': { en: 'Her Name is Alpha', jp: 'その名はアルファ', kr: '그 이름은 알파', zh: '其名为阿尔法', fr: 'Her Name is Alpha' },
  'dungeon.temporary-truce': { en: 'A Temporary Truce', jp: '一時休戦', kr: '일시 휴전', zh: '临时休战', fr: 'A Temporary Truce' },
  'dungeon.commanders-sophistry': { en: 'The Commander\'s Sophistry', jp: '騎士団長の詭弁', kr: '단장의 궤변', zh: '团长的诡辩', fr: "The Commander's Sophistry" },
  'dungeon.laplace-magnolia': { en: 'Laplace Magnolia', jp: 'ラプラス・マグノリア', kr: '라플라스 매그놀리아', zh: '拉普拉丝·麦格诺里亚', fr: 'Laplace Magnolia' },
  'dungeon.pass': { en: 'Pass', jp: '合格', kr: '합격', zh: '通过', fr: 'Pass' },
  'dungeon.automatons-wish': { en: 'An Automaton\'s Wish', jp: 'オートマタの願い', kr: '자동인형의 바람', zh: '机械人偶的心愿', fr: "An Automaton's Wish" },
  'dungeon.unjust-fight': { en: 'An Unjust Fight', jp: '仁義なき戦い', kr: '인의 없는 싸움', zh: '不讲仁义的战斗', fr: 'An Unjust Fight' },
  'dungeon.responsibility-of-guilty': { en: 'The Responsibility of the Guilty', jp: '奪った者の責任感', kr: '빼앗은 자의 책임감', zh: '掠夺者的责任感', fr: 'The Responsibility of the Guilty' },
  'dungeon.unchanging': { en: 'Unchanging', jp: '何も変わってなどない', kr: '아무것도 변한 것 없이', zh: '一切都没有变', fr: 'Unchanging' },
}
...
export const DESCRIPTIONS: Record<string, LangMap> = {
  'progress.task.joint-challenge': {
    ...
    kr: '서버 전체 협동 모드',
    zh: '全服协作模式',
    fr: 'Mode co-op à l\'echelle du serveur',
  },
  'progress.shop.guild': {
    ...
    kr: '길드 가입 또는 생성',
    zh: '加入或创建公会',
    fr: 'Rejoindre ou créer une guilde',
  },
  'content.base': {
    ...
    zh: '解锁基地，包含制作、商店等功能',
    fr: 'Debloque la Base avec crafting, shop et autres fonctionnalites',
  },
  'content.event-dungeon': {
    ...
    kr: '이벤트 던전 입장 가능',
    zh: '可进入活动暗堡',
    fr: 'Autorise l\'entree aux event dungeons',
  },
  ...
  'talisman': {
    ...
    kr: '탈리스만 장비 슬롯 해금',
    zh: '解锁护身符装备栏',
    fr: 'Debloque le slot d\'équipement Talisman',
  },
  'categories.skyward-tower': {
    ...
    fr: 'Challenge de tour mensuel - débloqué {P/Sigma}',
  },
  ...
  'content.arena': {
    ...
    zh: '与AI防守队伍对战的PvP模式',
    fr: 'Mode PvP contre des équipes de defense IA',
  },
  'content.archdemon-corridor': {
    ...
    zh: '每3天冷却可获得奖励的暗堡',
    fr: 'Dungeon repetable avec des récompenses en cooldown de 3 jours',
  },
  ...
  'content.synchro-room': {
    ...
    zh: '放置的英雄根据房间升级获得属性',
    fr: 'Les Héros places ici gagnent des stats selon les upgrades de la room',
  },
  ...
  'content.quirk': {
    ...
    zh: '全账号永久属性加成',
    fr: 'Bonus de stat permanents à l\'echelle du compte',
  },
  'progress.task.adventure-license': {
    ...
    zh: '有各种奖励的每周挑战模式',
    fr: 'Mode challenge hebdomadaire avec récompenses variees',
  },
  'content.irregular-extermination': {
    ...
    zh: '专属武器、饰品及其他奖励',
    fr: 'Armes, accessoires exclusifs et autres récompenses',
  },
}
