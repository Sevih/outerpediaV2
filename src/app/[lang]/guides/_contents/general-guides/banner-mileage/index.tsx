...
const LABELS = {
  title: {
    ...
    kr: '배너 & 마일리지 작동 방식',
    zh: '卡池和指定招募机制说明',
    fr: 'Fonctionnement des Banners et du Mileage',
  } satisfies LangMap,
  ...
  pickup: {
    label: { en: 'Custom Rate Up', jp: 'カスタムピックアップ', kr: '커스텀 픽업', zh: '自选UP', fr: 'Custom Rate Up' } satisfies LangMap,
    heading: { en: 'Custom Rate Up Banner', jp: 'カスタムピックアップ募集', kr: '커스텀 픽업 모집', zh: '自选UP招募', fr: 'Custom Rate Up Banner' } satisfies LangMap,
    specialFeature: {
    ...
    example_label: { en: 'Example:', jp: '例：', kr: '예시:', zh: '例如：', fr: 'Exemple :' } satisfies LangMap,
    example_before: {
      en: ' If you select ',
      jp: ' ',
      kr: ' ',
  ...
  rateup: {
    label: { en: 'Rate Up Banner', jp: 'ピックアップ募集', kr: '픽업 모집', zh: 'UP招募', fr: 'Rate Up Banner' } satisfies LangMap,
    heading: { en: 'Rate Up Banner', jp: 'ピックアップ募集', kr: '픽업 모집', zh: 'UP招募', fr: 'Rate Up Banner' } satisfies LangMap,
    specialFeature: {
      en: 'Using Recruit x 10 guarantees at least one 2★ hero',
      jp: '10連募集で2★以上のヒーローが1体以上確定',
      kr: '10연 모집 시 2★ 이상 영웅 1체 이상 확정',
    ...
    desc_duration: { en: '2 weeks', jp: '2週間', kr: '2주간', zh: '2周', fr: '2 semaines' } satisfies LangMap,
    desc_after: { en: '.', jp: '開催されます。', kr: ' 운영됩니다.', zh: '。', fr: '.' } satisfies LangMap,
    warning: {
      en: "It's not recommended to use Ether on this banner",
      jp: 'このバナーでエーテルを使用することは推奨されません',
      kr: '이 배너에서 에테르 사용은 권장되지 않습니다',
  ...
  premium: {
    label: { en: 'Premium Banner', jp: 'プレミアム募集', kr: '프리미엄 모집', zh: '精选招募', fr: 'Premium Banner' } satisfies LangMap,
    heading: { en: 'Premium Banner', jp: 'プレミアム募集', kr: '프리미엄 모집', zh: '精选招募', fr: 'Premium Banner' } satisfies LangMap,
    subtext: {
  ...
  limited: {
    label: { en: 'Limited Banner', jp: '限定募集', kr: '한정 모집', zh: '限定招募', fr: 'Limited Banner' } satisfies LangMap,
    heading: { en: 'Limited Banner', jp: '限定募集', kr: '한정 모집', zh: '限定招募', fr: 'Limited Banner' } satisfies LangMap,
    specialFeature: {
      en: 'Using Recruit x 10 guarantees at least one 2★ hero',
      jp: '10連募集で2★以上のヒーローが1体以上確定',
      kr: '10연 모집 시 2★ 이상 영웅 1체 이상 확정',
    ...
    type_limited_label: { en: 'Limited:', jp: '限定:', kr: '한정:', zh: '限定:', fr: 'Limited :' } satisfies LangMap,
    type_limited_desc: {
    ...
    type_seasonal_label: { en: 'Seasonal:', jp: 'シーズン:', kr: '시즌:', zh: '季节：', fr: 'Seasonal :' } satisfies LangMap,
    type_seasonal_desc: {
    ...
    type_collab_label: { en: 'Collab:', jp: 'コラボ:', kr: '콜라보:', zh: '联动:', fr: 'Collab :' } satisfies LangMap,
    type_collab_desc: {
    ...
    duration_value: { en: '2 to 4 weeks', jp: '2〜4週間', kr: '2~4주간', zh: '2至4周', fr: '2 à 4 semaines' } satisfies LangMap,
    duration_after: {
