...
export const LABELS = {
    ...
    sources: {
        ...
        'timegate.source.arena-weekly-reward': { en: 'Weekly Play Reward', jp: 'ウィークリープレイ報酬', kr: '주간 플레이 보상', zh: '每周游戏奖励', fr: 'Recompense de Jeu Hebdomadaire' },
        ...
        'timegate.source.singularity-rank-reward': { en: 'Dimensional Singularity – SSS++ Rank Reward', jp: '次元特異点 – SSS++ ランク報酬', kr: '차원 특이점 – SSS++ 등급 보상', zh: '次元奇点 – SSS++ 评级奖励', fr: 'Dimensional Singularity – Recompense Rank SSS++' },
    ...
    cost: {
        ...
        fr: { prefix: 'cout ', suffix: '', amountFirst: true },
