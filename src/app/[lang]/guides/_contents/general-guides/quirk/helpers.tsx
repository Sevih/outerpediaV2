...
/* ===================== Official Terms ===================== */
export const TERMS = {
  quirk: { en: 'Quirk', jp: 'ギフト', kr: '기프트', zh: '天赋', fr: 'Quirk' },
  classEnhancement: { en: 'Class Enhancement', jp: '戦闘タイプ強化', kr: '직업 강화', zh: '职业强化', fr: 'Class Enhancement' },
  utility: { en: 'Utility', jp: '実用関連', kr: '유틸리티', zh: '效益', fr: 'Utility' },
  elementEnhancement: { en: 'Element Enhancement', jp: '属性強化', kr: '속성 강화', zh: '属性强化', fr: 'Élément Enhancement' },
  counteractStrongEnemies: { en: 'Counteract Strong Enemies', jp: '強敵対応', kr: '강적 대응', zh: '应对强敌', fr: 'Counteract Strong Enemies' },
  adventureLicense: { en: 'Adventure License', jp: '冒険者ライセンス', kr: '모험 라이선스', zh: '冒险许可证', fr: 'Adventure License' },
} as const;
