...
const BOSSES = {
  ironStretcher:  { icons: '4013071', name: { en: 'Iron Stretcher',  kr: '아이언 스트레쳐', jp: 'アイアンストレッチャー', zh: '铁血伸张者',   fr: 'Iron Stretcher' } satisfies LangMap },
  blockbuster:    { icons: '4013072', name: { en: 'Blockbuster',     kr: '블록버스터',       jp: 'ブラックバスター',       zh: '破坏猛兽',     fr: 'Blockbuster' } satisfies LangMap },
  mutatedWyvre:   { icons: '4014003', name: { en: 'Mutated Wyvre',   kr: '변이된 와이브르',  jp: '変異したワイブル',       zh: '变异双足飞龙', fr: 'Mutated Wyvre' } satisfies LangMap },
  irregularQueen: { icons: '4089001', name: { en: 'Irregular Queen', kr: '이레귤러 퀸',      jp: 'イレギュラークイーン',   zh: '异型怪女王',   fr: 'Irregular Queen' } satisfies LangMap },
} as const;
...
const SWEEP_ROWS = [
  ...
  },
  {
    ...
    cost:   { en: '50 {I-I/Stamina}/chapter',        jp: '50{I-I/Stamina}/章',         kr: '50{I-I/Stamina}/챕터',  zh: '50{I-I/Stamina}/章',   fr: '50 {I-I/Stamina}/chapitre' } satisfies LangMap,
    reason: { en: 'Main source of {I-I/Gold}, 6★ red gear, {I-I/Survey Points} & {I-I/Legendary Reforge Catalyst}', jp: '{I-I/Gold}・6★赤装備・{I-I/Survey Points}・{I-I/Legendary Reforge Catalyst}の主な入手先', kr: '{I-I/Gold}, 6★ 레드 장비, {I-I/Survey Points} & {I-I/Legendary Reforge Catalyst} 주요 수급처', zh: '{I-I/Gold}、6★红装、{I-I/Survey Points}和{I-I/Legendary Reforge Catalyst}的主要来源', fr: 'Source principale de {I-I/Gold}, gear rouge 6★, {I-I/Survey Points} et {I-I/Legendary Reforge Catalyst}' } satisfies LangMap,
  },
] as const;

const SWEEP_OPTIONAL = {
  name:   { en: 'Special Request: Ecology Study (Stage 13)', jp: '特別依頼:生態調査（Lv.13）', kr: '특별의뢰: 생태 조사 (13단계)', zh: '特别委托:生态调查(第13关)', fr: 'Special Request : Ecology Study (Stage 13)' } satisfies LangMap,
  cost:   { en: '480 {I-I/Stamina}/day',            jp: '480{I-I/Stamina}/日',        kr: '480{I-I/Stamina}/일',   zh: '480{I-I/Stamina}/天',   fr: '480 {I-I/Stamina}/jour' } satisfies LangMap,
  reason: { en: 'Provides {I-I/Armor Glunite Fragment} for crafting {I-I/Armor Glunite} and 6★ legendary gear (transcend fodder if stats are bad)', jp: '{I-I/Armor Glunite}の精製用{I-I/Armor Glunite Fragment}と6★伝説装備（ステータスが悪ければ超越素材）', kr: '{I-I/Armor Glunite} 제작용 {I-I/Armor Glunite Fragment} 및 6★ 전설 장비（스탯이 안 좋으면 초월 재료）', zh: '提供用于合成{I-I/Armor Glunite}的{I-I/Armor Glunite Fragment}及6★传说装备（属性差时用于超越材料）', fr: 'Fournit des {I-I/Armor Glunite Fragment} pour crafter de l\'{I-I/Armor Glunite} et du gear legendary 6★ (fodder de transcend si les stats sont mauvaises)' } satisfies LangMap,
} as const;
