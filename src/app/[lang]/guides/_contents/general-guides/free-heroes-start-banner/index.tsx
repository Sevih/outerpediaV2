...
const S = {
  heading: {
    ...
    kr: '모든 무료 캐릭터 & 조언',
    zh: '所有免费角色与建议',
    fr: 'Tous les Personnages Gratuits & Conseils',
  } satisfies LangMap,
  ...
  thSource: {
    en: 'Source', jp: '入手先', kr: '획득처', zh: '获取途径', fr: 'Source',
  } satisfies LangMap,
  thCharacters: {
    en: 'Characters', jp: 'キャラクター', kr: '캐릭터', zh: '角色', fr: 'Personnages',
  } satisfies LangMap,
  thDetails: {
    en: 'Details', jp: '詳細', kr: '상세', zh: '详情', fr: 'Details',
  } satisfies LangMap,

  chooseOne: {
    en: 'Choose one', jp: '1人選ぶ', kr: '1명 선별', zh: '选一个', fr: 'Choisissez un',
  } satisfies LangMap,
  ...
  notYetAvailable: {
    en: 'Not Yet Available', jp: '未実装キャラ', kr: '미구현 캐릭터', zh: '暂未实装', fr: 'Pas Encore Disponible',
  } satisfies LangMap,
  notYetDesc: {
