...
import boss404400162 from '@data/boss/404400162.json';
...
const preloadedBosses: Record<string, Boss> = {
  '404400162': boss404400162 as unknown as Boss,
};
...
export default function GuardianGuide() {
  ...
  return (
    ...
    >
      <LootTable bossId="404400162" />
      <BossDisplay
        bossName="Masterless Guardian"
      ...
      <CombatFootage
        videoId="jAJOiJgASCU"
        title="Masterless Guardian Combat Footage"
        author="Sevih"
        date="09/05/2025"
      />
    </GuideTemplate>
