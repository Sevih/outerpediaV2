...
import boss407600962 from '@data/boss/407600962.json';
...
const preloadedBosses: Record<string, Boss> = {
  '407600962': boss407600962 as unknown as Boss,
};
...
export default function AmadeusGuide() {
  ...
  return (
    ...
    >
      <LootTable bossId="407600962" />
      <BossDisplay
        bossName="Amadeus"
        modeKey="Special Request: Identification"
        defaultBossId="407600962"
      ...
      <CombatFootage
        videoId="2lbN-rK89xI"
        title="Amadeus 13 – Clean Run Showcase"
        author="Sevih"
        date="09/05/2025"
      />
    </GuideTemplate>
