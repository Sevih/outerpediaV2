...
import boss403400362 from '@data/boss/403400362.json';
...
const preloadedBosses: Record<string, Boss> = {
  '403400362': boss403400362 as unknown as Boss,
};
...
export default function GrandCalamariGuide() {
  ...
  return (
    ...
    >
      ...
      <CombatFootage
        videoId="O9cxC5paoes"
        title="Grand Calamari 13 – Clean Run Showcase"
        author="Sevih"
        date="09/05/2025"
      />
    </GuideTemplate>
