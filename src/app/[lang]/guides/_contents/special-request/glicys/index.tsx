...
import boss407600162 from '@data/boss/407600162.json';
...
const preloadedBosses: Record<string, Boss> = {
  '407600162': boss407600162 as unknown as Boss,
};
...
export default function GlicysGuide() {
  ...
  return (
    ...
    >
      <LootTable bossId="407600162" />
      <BossDisplay
        bossName="Glicys"
        modeKey="Special Request: Identification"
        defaultBossId="407600162"
      ...
      <CombatFootage
        videoId="NikwWwstygo"
        title="Glicys 13 – Clean Run Showcase"
        author="Sevih"
        date="09/05/2025"
      />
    </GuideTemplate>
