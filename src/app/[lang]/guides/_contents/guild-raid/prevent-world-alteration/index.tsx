...
/* -- Boss imports --------------------------------------------- */
import miniBossA from '@data/boss/440600105-3-1.json';
import miniBossB from '@data/boss/440600205-4-1.json';
import mainBoss from '@data/boss/440600010-B-1.json';
...
import v12_2025Phase2 from './versions/12-2025/phase2.json';

/* -- Version: 06-2025 ----------------------------------------- */
import v06_2025Override from './versions/06-2025/config.json';
import v06_2025Phase1 from './versions/06-2025/phase1.json';
import v06_2025Phase2 from './versions/06-2025/phase2.json';

/* -- Typed JSON casts (JSON imports have literal types) -------- */
const bosses: Record<string, Boss> = {
  '440600105-3-1': miniBossA as unknown as Boss,
  '440600205-4-1': miniBossB as unknown as Boss,
  '440600010-B-1': mainBoss as unknown as Boss,
};
...
export default function PreventWorldAlterationGuide() {
  return (
    <GuildRaidGuide
      title={str.title}
      ...
      versions={{
        dec2025: resolve(
          ...
          v12_2025Phase2 as unknown as GuildRaidPhase2Data,
        ),
        jun2025: resolve(
          v06_2025Override as GuildRaidVersionOverride,
          v06_2025Phase1 as unknown as Phase1Data,
          v06_2025Phase2 as unknown as GuildRaidPhase2Data,
        ),
      }}
    />
  );
