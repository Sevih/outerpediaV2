...
const SCRIPT = join(__dirname, '../../scripts/generate-item-names.py');
const OUTPUT = join(PATHS.equipment, 'item-names.json');
const STAMP = join(PATHS.generated, '.item-names-stamp');

const REQUIRED_INPUTS = ['ItemTemplet', 'TextItem'];
