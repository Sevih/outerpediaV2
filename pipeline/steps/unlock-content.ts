...
const SCRIPT = join(__dirname, '../../scripts/generate-unlock-content.py');
const OUTPUT = join(PATHS.generated, 'unlock-content.json');
const STAMP = join(PATHS.generated, '.unlock-content-stamp');
